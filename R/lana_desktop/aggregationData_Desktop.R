...
buildAggregationDesktopSettings <- function(xDimension, yDimension, logId, zDimension, aggrLevel, followers, type, cache, limit, page) {
...
aggregate_desktop <- function(logName, xDimension, yDimension, zDimension="null", aggrLevel="traces", followers="null", type="aggregation", cache="{}", limit = 10, page = 1){
